    ...
    <div className="bg-zinc-50 py-10 min-h-screen">
      <div className="container-max mx-auto px-4 sm:px-6">
        <section className="bg-white rounded-lg p-6 md:p-8 shadow-md">
          <h1 className="text-3xl md:text-4xl font-extrabold text-zinc-900 mb-6">About Us</h1>
          <div className="space-y-4 text-zinc-700 text-base md:text-lg">
            <p>
              Welcome to <span className="font-semibold text-zinc-900">SKS Mart - Barbigha</span>. We are a local apparel store offering
          ...
          <div className="grid sm:grid-cols-3 gap-6 mt-8 pt-6 border-t border-zinc-200">
            {/* Feature 1 */}
            <div className="p-4 bg-zinc-50 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-teal-600 mb-3">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <h3 className="font-semibold text-lg text-zinc-900 mb-2">Quality First</h3>
              <p className="text-zinc-600">Well-made fabrics and finishing you can feel.</p>
            </div>
            {/* Feature 2 */}
            <div className="p-4 bg-zinc-50 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-teal-600 mb-3">
              ...
              <h3 className="font-semibold text-lg text-zinc-900 mb-2">Fair Pricing</h3>
              <p className="text-zinc-600">Clear, honest prices with good value.</p>
            </div>
            {/* Feature 3 */}
            <div className="p-4 bg-zinc-50 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-teal-600 mb-3">
              ...
              <h3 className="font-semibold text-lg text-zinc-900 mb-2">Friendly Service</h3>
              <p className="text-zinc-600">A helpful, no-pressure in-store experience.</p>
            </div>
          </div>
        </section>
      </div>
